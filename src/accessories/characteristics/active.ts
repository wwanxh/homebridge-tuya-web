...
type DeviceWithActiveCharacteristic = TuyaDevice<
  TuyaDeviceState & ActiveCharacteristicData
>;
...
export class ActiveCharacteristic extends TuyaWebCharacteristic {
  ...
  public getRemoteValue(callback: CharacteristicGetCallback): void {
    this.accessory
      .getDeviceState<ActiveCharacteristicData>()
      .then((data) => {
  ...
  updateValue(
    data: DeviceWithActiveCharacteristic["data"] | undefined,
